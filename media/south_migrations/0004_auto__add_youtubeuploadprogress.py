...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'YoutubeUploadProgress'
        db.create_table(u'media_youtubeuploadprogress', (
            ('session_key', self.gf('django.db.models.fields.CharField')(max_length=40, primary_key=True)),
            ('progress_data', self.gf('media.fields.files.JSONField')(max_length=250)),
        ))
        db.send_create_signal(u'media', ['YoutubeUploadProgress'])


    def backwards(self, orm):
        # Deleting model 'YoutubeUploadProgress'
        db.delete_table(u'media_youtubeuploadprogress')
